        ...
        <div class="footer-section">
          ...
          <div class="footer-text">
            ...
            <ul>
              ...
              <li>
                <a href="https://www.officialgazette.gov.ph/privacy-policy/"
                  >Privacy Policy</a
                >
              </li>
              <li>
                <a href="https://www.officialgazette.gov.ph/faq/"
      ...
      <div class="row">
        <div class="small-12 columns">
          <p class="text-center attribution">
            <span class="mobile-block">Managed by ICT Division of the </span
            ><a
              href="https://pco.gov.ph"
              target="_blank"
              rel="noopener noreferrer"
              >Presidential Communications Office (PCO)</a
            >
          </p>
        </div>
      </div>
